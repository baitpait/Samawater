...
<nav class="sidebar-nav">
    <ul class="nav navbar-nav">
        ...
        @if (! $isDistributor)
            <li class="nav-item">
                <a class="nav-link" href="{{ route('delivery.bulk-entry') }}">
                    <i class="la la-layer-group"></i>
                    <span>تسليم جماعي</span>
                </a>
            </li>
        @endif
        <li class="nav-item">
        ...
        @if (! $isDistributor)
            ...
            {{-- 4. الموزعون --}}
            <li class="menu-section-label">الموزعون</li>
            <x-backpack::menu-item title="قائمة الموزعين" icon="la la-car" :link="route('distributors.list')" />

            <li class="sidebar-divider"></li>

            {{-- 5. المبيعات والتحصيل --}}
            <li class="menu-section-label">المبيعات والتحصيل</li>
            <x-backpack::menu-item title="فواتير المبيعات" icon="la la-file-invoice" :link="backpack_url('invoice')" />
            ...
            <li class="menu-section-label">المشتريات والموردون</li>
            ...
            @endif
            <x-backpack::menu-item title="الموردون" icon="la la-industry" :link="backpack_url('vendor')" />
            ...
            {{-- 9. التقارير المالية --}}
            <li class="menu-section-label">التقارير المالية</li>
            <x-backpack::menu-item title="الصندوق المالي (عهدة)" icon="la la-balance-scale" :link="route('reports.treasury-custody')" />
            ...
            <x-backpack::menu-item title="أرصدة المشتركين" icon="la la-wallet" :link="route('reports.client-balance')" />
            <x-backpack::menu-item title="دفتر المشترك المالي" icon="la la-book" :link="route('reports.client-ledger')" />
            ...
            @if (backpack_user()?->canManageUsers())
                <x-backpack::menu-item title="المستخدمون" icon="la la-users-cog" :link="backpack_url('user')" />
            @endif
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="https://wa.me/970599814758" target="_blank" rel="noopener noreferrer">
