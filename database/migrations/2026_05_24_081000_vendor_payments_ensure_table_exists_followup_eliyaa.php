...
/**
 * Business Purpose: إعادة إنشاء vendor_payments عند غيابه رغم تسجل هجرات الإصلاح (قواعد بُنيت من imports غير متزامنة مع جدول migrations).
 *
 * المنطق مُطابق لـ 2026_05_23_142500_repair_missing_vendor_payments_table_legacy_fks (تكرار مقصود لتجاوز phantom migration).
 */
return new class extends Migration
{
    ...
    /**
     * Business Purpose: إنشاء vendors من دون Laravel foreignId لمطابقة جداول قديمة عند الغياب.
     */
    private static function ensureVendorsSkeleton(): void
    {
