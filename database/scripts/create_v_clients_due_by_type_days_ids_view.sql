-- =============================================================================
-- إنشاء الـ view: v_clients_due_by_type_days_ids
-- مطلوب لقائمة التسليم وصفحات "العميل المستحق".
-- نفّذ هذا الملف على السيرفر إذا ظهر: Table 'xxx.v_clients_due_by_type_days_ids' doesn't exist
-- الاستخدام: mysql -u USER -p DATABASE_NAME < database/scripts/create_v_clients_due_by_type_days_ids_view.sql
-- =============================================================================
-- (تنفيذ كامل الملف من هنا. إذا ظهر خطأ ROP انسخ السطر التالي كاملاً أو نفّذ الملف من الطرفية.)

 DROP VIEW IF EXISTS v_clients_due_by_type_days_ids;
