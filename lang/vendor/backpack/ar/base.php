...
return [
    ...
    */
    ...
    'error_page' => [
        ...
        'message_4xx' => 'يُرجى <a :href_back>الرجوع للخلف</a> أو العودة إلى <a :href_homepage>الصفحة الرئيسية</a>.',
        'message_500' => 'حدث خطأ داخلي في الخادم. إذا استمر الخطأ، تواصل مع فريق التطوير.',
        'message_503' => 'الخادم مشغول أو مغلق للصيانة. حاول لاحقاً.',
        '400' => 'طلب غير صالح.',
        '401' => 'غير مصرّح بتنفيذ هذا الإجراء.',
        '403' => 'ممنوع: ليس لديك صلاحية للوصول إلى هذه الصفحة.',
        '404' => 'الصفحة غير موجودة.',
        '405' => 'طريقة الطلب غير مسموحة.',
        '408' => 'انتهى وقت انتظار الطلب.',
        '429' => 'عدد المحاولات كبير.',
        '500' => 'مشكلة من جانب الخادم.',
    ],
